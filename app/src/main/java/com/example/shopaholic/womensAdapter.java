...
public class womensAdapter extends RecyclerView.Adapter<womensAdapter.ViewHolder> {
    ...
    public womensAdapter() {
    }

    public womensAdapter(List<productModelClass> list_post) {
    ...
    @NonNull
    @Override
    public womensAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.picked_card,viewGroup,false);
        context=viewGroup.getContext();
        firebaseFirestore=FirebaseFirestore.getInstance();

        return new womensAdapter.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull womensAdapter.ViewHolder viewHolder, int i) {
        ...
        //String setReview=list_post.get(i).getProduct_review();
        //viewHolder.setReview(setReview);
       // String pickOfDay=list_post.get(i).getProduct_pick();
        //viewHolder.setPickofday(pickOfDay);
