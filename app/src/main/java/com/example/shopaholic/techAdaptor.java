...
public class techAdaptor extends RecyclerView.Adapter<techAdaptor.ViewHolder> {
    ...
    public techAdaptor(List<productModelClass> list_post) {
    ...
    @NonNull
    @Override
    public techAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.picked_card,viewGroup,false);
        context=viewGroup.getContext();
        firebaseFirestore=FirebaseFirestore.getInstance();

        return new techAdaptor.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull techAdaptor.ViewHolder viewHolder, int i) {
